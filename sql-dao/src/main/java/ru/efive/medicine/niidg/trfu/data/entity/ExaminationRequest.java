...
public class ExaminationRequest extends AbstractRequest implements ProcessedData {
    ...
    @JoinTable(name = "trfu_examination_requests_trfu_tests",
            joinColumns = {@JoinColumn(name = "trfu_examination_requests_id")},
