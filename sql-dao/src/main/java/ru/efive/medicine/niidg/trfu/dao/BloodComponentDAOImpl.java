...
public class BloodComponentDAOImpl extends GenericDAOHibernate<BloodComponent> {
    ...
    public List<BloodComponent> findDocuments(String filter, boolean showDeleted, int offset, int count, String orderBy, boolean orderAsc) {
        ...
        return (List<BloodComponent>) getHibernateTemplate().findByCriteria(getSearchCriteria(detachedCriteria, filter), offset, count);
    }
    ...
    public List<BloodComponent> findDocuments(
            Map<String, Object> in_map, boolean showDeleted, int offset, int count, String orderBy, boolean orderAsc
    ) {
        DetachedCriteria detachedCriteria = DetachedCriteria.forClass(getPersistentClass());
        detachedCriteria.setResultTransformer(DetachedCriteria.DISTINCT_ROOT_ENTITY);
        ...
        addOrders(detachedCriteria, orderBy, orderAsc);
        return (List<BloodComponent>) getHibernateTemplate().findByCriteria(getConjunctionSearchCriteria(detachedCriteria, in_map), offset, count);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<BloodComponent> findDocuments(
            String filter, int statusId, boolean showDeleted, int offset, int count, String orderBy, boolean orderAsc
    ) {
        DetachedCriteria detachedCriteria = DetachedCriteria.forClass(getPersistentClass());
        detachedCriteria.setResultTransformer(DetachedCriteria.DISTINCT_ROOT_ENTITY);
    ...
    @SuppressWarnings("unchecked")
    public List<BloodComponent> findDocuments(
            String filter, int statusId, boolean showExpired, boolean showDeleted, int offset, int count, String orderBy, boolean orderAsc
    ) {
        DetachedCriteria detachedCriteria = DetachedCriteria.forClass(getPersistentClass());
        detachedCriteria.setResultTransformer(DetachedCriteria.DISTINCT_ROOT_ENTITY);
    ...
    public List<BloodComponent> findComponentsByDonation(int donationId) {
        ...
        return (List<BloodComponent>) getHibernateTemplate().findByCriteria(detachedCriteria);
    }
    ...
    public List<BloodComponent> findComponentsByStatusId(boolean showDeleted, int statusId, int offset, int count, String orderBy, boolean orderAsc) {
        ...
        addOrders(detachedCriteria, orderBy, orderAsc);
        return (List<BloodComponent>) getHibernateTemplate().findByCriteria(detachedCriteria, offset, count);
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public List<BloodComponent> findQuarantinedDocuments(
            String filter, boolean showDeleted, int offset, int count, String orderBy, boolean orderAsc
    ) {
        DetachedCriteria detachedCriteria = DetachedCriteria.forClass(getPersistentClass());
        detachedCriteria.setResultTransformer(DetachedCriteria.DISTINCT_ROOT_ENTITY);
     ...
     */
    @SuppressWarnings("unchecked")
    public List<BloodComponent> findQuarantinedDocumentsByDonor(
            Donor donor, String filter, boolean showDeleted, int offset, int count, String orderBy, boolean orderAsc
    ) {
        DetachedCriteria detachedCriteria = DetachedCriteria.forClass(getPersistentClass());
        detachedCriteria.setResultTransformer(DetachedCriteria.DISTINCT_ROOT_ENTITY);
        if (!showDeleted) {
    ...
    @SuppressWarnings("unchecked")
    public List<BloodComponent> findDocumentsInQuarantineByDonor(
            Donor donor, String filter, boolean showDeleted, int offset, int count, String orderBy, boolean orderAsc
    ) {
        DetachedCriteria detachedCriteria = DetachedCriteria.forClass(getPersistentClass());
        detachedCriteria.setResultTransformer(DetachedCriteria.DISTINCT_ROOT_ENTITY);
    ...
    public List<BloodComponent> findDocumentsByFullNumber(String parentNumber, String number, boolean showDeleted) {
        ...
        return (List<BloodComponent>) getHibernateTemplate().findByCriteria(detachedCriteria, -1, -1);
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public List<BloodComponent> findComponentsByPhenotypes(
            List<Analysis> phenotypes,
            boolean searchBloodGroup,
            String bloodGroup,
            boolean searchRhesus,
            String rhesusFactor,
            String orderBy,
            boolean orderAsc
    ) {
        ...
        boolean hasPhenotypes = phenotypes.size() != 0;

        for (Analysis phenotype : phenotypes) {
            if (!testsSubQuery.toString().equals("")) {
                testsSubQuery.append(" or ");
            }
            testsSubQuery.append("binary value = '").append(phenotype.getType().getValue()).append("'");
    ...
    @SuppressWarnings("unchecked")
    public List<BloodComponent> findControlledComponentsByStatusId(
            String filter, int statusId, boolean showDeleted, int offset, int count, String orderBy, boolean orderAsc
    ) {
        DetachedCriteria detachedCriteria = DetachedCriteria.forClass(getPersistentClass());
        detachedCriteria.setResultTransformer(DetachedCriteria.DISTINCT_ROOT_ENTITY);
    ...
    @SuppressWarnings("unchecked")
    public List<BloodComponent> findQuarantinedComponentsByStatusId(
            String filter, int statusId, boolean showDeleted, int offset, int count, String orderBy, boolean orderAsc
    ) {
        DetachedCriteria detachedCriteria = DetachedCriteria.forClass(getPersistentClass());
        detachedCriteria.setResultTransformer(DetachedCriteria.DISTINCT_ROOT_ENTITY);
        ...
        return new ArrayList<>(
                new LinkedHashSet<BloodComponent>(
                        (Collection<? extends BloodComponent>) getHibernateTemplate().findByCriteria(
    ...
    public List<BloodComponent> findUniquieSplitComponents() {                        
        ...
        try(final Session session = getHibernateTemplate().getSessionFactory().openSession()) {
            ...
            if (list.size() > 0) {
                ...
                return (List<BloodComponent>) getHibernateTemplate().findByCriteria(criteria);
            } else {
                return Collections.emptyList();
            }
        }
    ...
    public BloodComponent findParentComponent(BloodComponent splitComponent) {   
        DetachedCriteria detachedCriteria = DetachedCriteria.forClass(BloodComponent.class)
                .setResultTransformer(DetachedCriteria.DISTINCT_ROOT_ENTITY).
                        ...
                        add(Restrictions.eq("parentNumber", splitComponent.getParentNumber())).add(
                        Restrictions.eq(
                                "number", splitComponent.getNumber()
                        )
                );

        List<BloodComponent> list = (List<BloodComponent>) getHibernateTemplate().findByCriteria(detachedCriteria);
        if (list.isEmpty()) {
            return null;
        } else {
            return list.get(0);
    ...
    @SuppressWarnings("unchecked")
    public List<BloodComponent> findDocuments(
            BloodComponentsFilter filter, int offset, int count, String orderBy, boolean orderAsc
    ) {
        ...
        return (List<BloodComponent>) getHibernateTemplate().findByCriteria(criteria, offset, count);
    }
    ...
    protected DetachedCriteria getSearchCriteria(
            DetachedCriteria criteria, BloodComponentsFilter filter
    ) {
        if (filter != null) {
            Conjunction conjunction = Restrictions.conjunction();
    ...
    public List<BloodComponent> findDocuments(
            String filter,
            List<Integer> bloodComponentStatusIdList,
            List<Integer> donationStatusIdList,
            boolean showExpired,
            boolean showDeleted,
            int offset,
            int count,
    ...
    public long countDocument(
            String filter, List<Integer> bloodComponentStatusIdList, List<Integer> donationStatusIdList, boolean showExpired, boolean showDeleted
    ) {
        DetachedCriteria detachedCriteria = DetachedCriteria.forClass(getPersistentClass());
        detachedCriteria = setVirusinaktivationCriteria(detachedCriteria, bloodComponentStatusIdList, donationStatusIdList, showExpired, showDeleted);
    ...
    private DetachedCriteria setVirusinaktivationCriteria(
    ...
    public int getLastNumberByDonation(final String donationNumber, final boolean purchased) {
        final DetachedCriteria detachedCriteria = DetachedCriteria.forClass(BloodComponent.class)
                .setResultTransformer(DetachedCriteria.DISTINCT_ROOT_ENTITY);
        detachedCriteria.add(Restrictions.eq("deleted", false));
        ...
        final List<BloodComponent> resultList = (List<BloodComponent>) getHibernateTemplate().findByCriteria(detachedCriteria, -1, 1);
