...
/**
 * Результат подбора донора
 * 
 * @author Alexey Vagizov
 */
@Entity
@Table(name = "trfu_donor_match")
public class DonorMatch extends IdentifiedEntity {
	...
	@JoinTable(name = "trfu_donor_match_results", 
	...
	private static final long serialVersionUID = 1037876839307345197L;
}