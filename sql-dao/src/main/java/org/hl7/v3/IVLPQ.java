    ...
    extends SXCMPQ
{
    ...
    protected List<JAXBElement<? extends PQ>> highOrCenterOrWidth;

    /**
     * Gets the value of the highOrCenterOrWidth property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the highOrCenterOrWidth property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getHighOrCenterOrWidth().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<JAXBElement<? extends PQ>> getHighOrCenterOrWidth() {
        if (highOrCenterOrWidth == null) {
            highOrCenterOrWidth = new ArrayList<JAXBElement<? extends PQ>>();
        }
        return this.highOrCenterOrWidth;
    }
