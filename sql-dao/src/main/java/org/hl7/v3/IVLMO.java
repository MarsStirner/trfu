    ...
    extends SXCMMO
{
    ...
    protected List<JAXBElement<? extends MO>> highOrLowOrCenter;
     ...
     * 
     */
    public List<JAXBElement<? extends MO>> getHighOrLowOrCenter() {
        if (highOrLowOrCenter == null) {
            highOrLowOrCenter = new ArrayList<JAXBElement<? extends MO>>();
        }
