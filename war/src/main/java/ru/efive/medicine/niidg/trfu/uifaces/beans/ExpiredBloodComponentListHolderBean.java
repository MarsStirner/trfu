...
@Named("expiredBloodComponentList")
@SessionScoped
public class ExpiredBloodComponentListHolderBean extends AbstractDocumentListHolderBean<BloodComponent> {
	...
	public Sorting initSorting() {
		return new Sorting("expirationDate", false);
	}
