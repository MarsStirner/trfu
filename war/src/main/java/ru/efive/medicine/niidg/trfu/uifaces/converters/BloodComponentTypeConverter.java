...
public class BloodComponentTypeConverter implements Converter {
	...
	public Object getAsObject(FacesContext context, UIComponent component, String value) {
		...
		try {
			...
			List<BloodComponentType> list = sessionManagement.getDictionaryDAO(DictionaryDAOImpl.class, ApplicationHelper.DICTIONARY_DAO).findComponentTypeByValue(value);
			if (list.size() > 0) {
				result = list.get(0);
			}
		}
