...
@SessionScoped
public class DonorQuarantineFinishInviteListHolderBean extends AbstractDocumentListHolderBean<Donor> {
	...
	protected int getTotalCount() {
		int result = 0;
		try {
			long count = sessionManagement.getDAO(DonorDAOImpl.class, "donorDao").countQuarantineFinishInviteDocument(filter, false);
